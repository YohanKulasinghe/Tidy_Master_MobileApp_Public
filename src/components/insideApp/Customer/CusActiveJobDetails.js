...
export default class CusActiveJobDetails extends Component {
          ...
          <View>
            ...
            <List dataArray={this.state.data} renderRow={(item) => 
               ...
               <View style={styles.item}>
                ...
                <Text></Text>
               <Button full rounded style={styles.confirm} onPress={() => {Actions.PayAndPromote({postid:item.postid})}}>
                <Text>Pay and Promote</Text></Button>
               </Body>
             </ListItem>
              }>
            </List>
