      ...
      return (
        <Container>
          <Content>
            ...
            <Button full rounded style={styles.confirm} onPress={()=>Actions.ViewCleanerLocation()}>
                 <Text>View Cleaner Location</Text></Button>

            <Button full rounded style={styles.confirm} onPress={()=>Actions.QRScan()}>
            <Text>Confirm Job Done</Text></Button>
